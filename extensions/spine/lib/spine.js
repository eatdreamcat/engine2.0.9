...
(function(spine) {
    ...
    var RotateTimeline = (function(_super) {
        ...
        RotateTimeline.prototype.setFrame = function(
            ...
            frameIndex <<= 1;
            if (isNaN(time)) {
                console.warn(" time is NaN in RotateTimeline setFrame");
                time = 0.0;
                console.warn(this.frames);
            }
    ...
    var TranslateTimeline = (function(_super) {
        ...
        TranslateTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(" time is NaN in TranslateTimeline setFrame");
                time = 0.0;
                console.warn(this.frames);
            }
            this.frames[frameIndex] = time;
    ...
    var ColorTimeline = (function(_super) {
        ...
        ColorTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(" time is NaN in ColorTimeline setFrame");
                time = 0.0;
                console.warn(this.frames);
            }
            this.frames[frameIndex] = time;
    ...
    var TwoColorTimeline = (function(_super) {
        ...
        TwoColorTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(" time is NaN in TwoColorTimeline setFrame");
                time = 0.0;
                console.warn(this.frames);
            }
            this.frames[frameIndex] = time;
    ...
    var AttachmentTimeline = (function() {
        ...
        AttachmentTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(" time is NaN in AttachmentTimeLine setFrame");
                console.warn(this.frames);
                time = 0.0;
            }
            this.frames[frameIndex] = time;
    ...
    var DeformTimeline = (function(_super) {
        ...
        DeformTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(" time is NaN in DeformTimeline setFrame");
                time = 0.0;
                console.warn(this.frames);
            }
            this.frames[frameIndex] = time;
    ...
    var EventTimeline = (function() {
        ...
        EventTimeline.prototype.setFrame = function(frameIndex, event) {
            if (isNaN(event.time)) {
                console.warn(" time is NaN in EventTimeline setFrame");
                event.time = 0.0;
                console.warn(this.frames);
            }
    ...
    var DrawOrderTimeline = (function() {
        ...
        DrawOrderTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(" time is NaN in DrawOrderTimeline setFrame");
                time = 0.0;
                console.warn(this.frames);
            }
            this.frames[frameIndex] = time;
    ...
    var IkConstraintTimeline = (function(_super) {
        ...
        IkConstraintTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(" time is NaN in IkConstraintTimeline setFrame");
                time = 0.0;
                console.warn(this.frames);
            }
            this.frames[frameIndex] = time;
    ...
    var TransformConstraintTimeline = (function(_super) {
        ...
        TransformConstraintTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(
                    " time is NaN in TransformConstraintTimeline setFrame"
                );
                time = 0.0;
                console.warn(this.frames);
            }
    ...
    var PathConstraintPositionTimeline = (function(_super) {
        ...
        PathConstraintPositionTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(
                    " time is NaN in PathConstraintPositionTimeline setFrame"
                );
                time = 0.0;
                console.warn(this.frames);
            }
    ...
    var PathConstraintMixTimeline = (function(_super) {
        ...
        PathConstraintMixTimeline.prototype.setFrame = function(
            ...
            if (isNaN(time)) {
                console.warn(
                    " time is NaN in PathConstraintMixTimeline setFrame"
                );
                time = 0.0;
                console.warn(this.frames);
            }
...
(function(spine) {
    var SkeletonClipping = (function() {
        ...
        SkeletonClipping.prototype.clipTriangles = function(
            ...
            outer: for (
                var i = originIndexOffset,
                    n = originIndexOffset + trianglesLength;
                i < n;
                i += 3
            ) {
...
(function(spine) {
    var SkeletonJson = (function() {
        ...
        SkeletonJson.prototype.readSkeletonData = function(json) {
            ...
            if (root.skins) {
                if (root.skins.constructor.name == "Object") {
                ...
                } else if (root.skins.constructor.name == "Array") {
                    for (let skinObj of root.skins) {
                        let skinName = skinObj.name;
                        var skinMap = skinObj.attachments;
                        var skin = new spine.Skin(skinName);
                        for (var slotName in skinMap) {
                            var slotIndex = skeletonData.findSlotIndex(
                                slotName
        ...
        SkeletonJson.prototype.readAnimation = function(
            ...
            window.checkDuration = function(duration, key) {
                if (isNaN(duration)) {
                    console.error(" duration is NaN : " + key);
                }
            };
            var scale = this.scale;
                ...
                for (var slotName in map.slots) {
                    ...
                    for (var timelineName in slotMap) {
                        ...
                        if (timelineName == "attachment") {
                            ...
                            checkDuration(duration, timelineName);
                        ...
                        for (var timelineName in slotMap) {
                            ...
                            for (var j = 0; j < timelineMap.length; j++) {
                                ...
                                if (verticesValue == null)
                                    ...
                                    deform = spine.Utils.newFloatArray(
                                        deformLength
                                    );
